...
def main():
    ...
    parser.add_argument("--text", type=str, default="The quick brown fox jumps over the lazy dog.", help="Text to process")
    parser.add_argument("--device", type=str, default="cuda" if torch.cuda.is_available() else "cpu", help="Device to use")
    parser.add_argument("--save_hf_model", type=str, default=None, help="Save the model in HF format to this directory")
    parser.add_argument("--push_to_hub", type=str, default=None, help="Push model to HF Hub with this repo ID")
    ...
    if args.push_to_hub:
        ...
        tokenizer.push_to_hub(args.push_to_hub, commit_message="Upload tokenizer for ISCA model")
